...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Renuka Joshi", bg="#3873ea", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Aashi Gangrade", bg="#ffeaa7", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Khyati Agrawal", bg="#f8a5c2", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
